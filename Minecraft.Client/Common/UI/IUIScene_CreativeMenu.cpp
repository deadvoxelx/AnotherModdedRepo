...
void IUIScene_CreativeMenu::staticCtor()
{
	...
	DEF(eCreativeInventory_BuildingBlocks)
		...
		ITEM(Tile::limestoneIron_Id)
		ITEM(Tile::graniteIron_Id)
		ITEM(Tile::lapisOre_Id)
		ITEM(Tile::limestoneLapis_Id)
		ITEM(Tile::graniteLapis_Id)
		ITEM(Tile::goldOre_Id)
		ITEM(Tile::limestoneGold_Id)
		ITEM(Tile::graniteGold_Id)
		ITEM(Tile::redStoneOre_Id)
		ITEM(Tile::limestoneRedstone_Id)
		ITEM(Tile::graniteRedstone_Id)
		ITEM(Tile::diamondOre_Id)
		ITEM(Tile::limestoneDiamond_Id)
		ITEM(Tile::graniteDiamond_Id)
		...
		ITEM_AUX(Tile::coloredPlanks_Id, 0)
		ITEM_AUX(Tile::coloredPlanks_Id, 1)
		ITEM_AUX(Tile::coloredPlanks_Id, 2)
		ITEM_AUX(Tile::coloredPlanks_Id, 3)
		ITEM_AUX(Tile::coloredPlanks_Id, 4)
		ITEM_AUX(Tile::coloredPlanks_Id, 5)
		ITEM_AUX(Tile::coloredPlanks_Id, 6)
		ITEM_AUX(Tile::coloredPlanks_Id, 7)
		ITEM_AUX(Tile::coloredPlanks_Id, 8)
		ITEM_AUX(Tile::coloredPlanks_Id, 9)
		ITEM_AUX(Tile::coloredPlanks_Id, 10)
		ITEM_AUX(Tile::coloredPlanks_Id, 11)
		ITEM_AUX(Tile::coloredPlanks_Id, 12)
		ITEM_AUX(Tile::coloredPlanks_Id, 13)
		...
		ITEM(Item::door_pink_Id)
		ITEM(Item::door_yellow_Id)
		ITEM(Item::door_green_Id)
		ITEM(Item::door_iron_Id)
		ITEM(Item::door_gold_Id)

		ITEM(Tile::trapdoor_Id)
		ITEM(Tile::trapdoorSpruce_Id)
		ITEM(Tile::trapdoorBirch_Id)
		ITEM(Tile::trapdoorJungle_Id)
		ITEM(Tile::trapdoorPink_Id)
		ITEM(Tile::trapdoorYellow_Id)
		ITEM(Tile::trapdoorGreen_Id)
...
//		ITEM_AUX(Tile::stoneSlabHalf_Id,StoneSlabTile::WOOD_SLAB)
	...
	DEF(eCreativeInventory_Decoration)
		...
		ITEM(Tile::cherrySapling_Id)
		ITEM(Tile::palmSapling_Id)
		ITEM(Tile::mossySapling_Id)
		...
		ITEM_AUX(Tile::leaves2_Id, Leaf2Tile::CHERRY_LEAF)
		ITEM_AUX(Tile::leaves2_Id, Leaf2Tile::PALM_LEAF)
		ITEM(Tile::vine)
	...
	DEF(eCreativeInventory_Misc)
		...
		ITEM_AUX(Item::spawnEgg_Id, 89); // Fox
	...
	DEF(eCreativeInventory_ToolsArmourWeapons)
		...
		ITEM(Item::arrow_Id)
		ITEM(Item::steelHelmet_Id)
		ITEM(Item::steelChestplate_Id)
		ITEM(Item::steelLeggings_Id)
		ITEM(Item::steelBoots_Id)
		ITEM(Item::steelSword_Id)
		ITEM(Item::steelShovel_Id)
		ITEM(Item::steelPickaxe_Id)
		ITEM(Item::steelAxe_Id)
		ITEM(Item::steelHoe_Id)
